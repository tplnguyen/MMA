...
{
	if (!confirm("You are about to clear the WHOLE canvas, are you sure? If you just want to erase something, try to change the brush color to your background color ;) Good luck!"))
		return;
